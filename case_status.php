...
<body class="bg_green">
    ...
    <div class="container" style="margin-top: 160px;">
        ...
        <div class="form_box">
        <div class="form_heading">Case Status</div>
            <form method="post" id="form_id_case_status" name="form_id_case_status">
                ...
                <div class="form-group">
                    ...
                    <select required="required" class="form-control" name="search_by" id="search_by"
                        ...
                        <option value="5">By Advocate</option>
    ...
    <div class="modal fade modal_ngt" id="case_details_popup_hearing" role="dialog">
        <div class="modal-dialog modal-dialog-centered  modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container_inner" id="div_case_details_popup_hearing">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- 
    <footer>Designed & Developed by National Informatics Centre (NIC)</footer> -->

    <?php 
$search_by = isset($_REQUEST['search_by']) ? $_REQUEST['search_by'] : 3;
?>
    <script>
