...
$bench_sql =$db->prepare("insert into $schemas.notice_creation_details (filing_no,
case_no,send_date,notice_type,notice_date,party_admission,sec_of_act,concise_applicant,behalf_applicant,address,tel_no,fax,email,prescribed_under_rule,reh_tr_petition_no,matters_from,remarks,today_date,other_matter,user_id,reh_tr_type,case_type,case_year,bench_loc,ins_relief,file_no,fixed3a,on3a,bench3a,to_3b,
...
if($prt_type==2)
	{
 	$manual_case_number = $Diary_no.'/'.$Diary_year;
	$msg = "Record Inserted Sucessfully";
	$msg1 ="  Diary Number  ".$manual_case_number;
	}
*/

//header("Location:./create_notice.php?msg=$message");
