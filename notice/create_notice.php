...
<?php
$st = $db->prepare("select * from $schemas.master_notice where display = 'TRUE' order by priority asc");
$st->execute();
while ($row = $st->fetch(PDO::FETCH_ASSOC,PDO::FETCH_ORI_NEXT))
{
...
<!--<input type="text" id="n_date"  autocomplete="off" name="n_date" 
  ...
  <input type="text"  maxlength="10" size="10" name="n_date" id="n_date" class="datepickerToday" value="<?php print htmlspecialchars($n_date); ?>" 
</td>
</tr>
<?php
if($notice_type==1)
...
<option value="">Select</option>
<?php
$st = $db->prepare("select * from master_notice_order_type where display = 'Y' order by order_type_name asc");
$st->execute();
while ($row = $st->fetch(PDO::FETCH_ASSOC,PDO::FETCH_ORI_NEXT))
{
...
<tr>
<td>
<font face="Verdana" size="2">Room No.</font>
<center>
<?php  $us1_3B = isset($_REQUEST['us1_3B']) ? $_REQUEST['us1_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us1_3B"><?php print htmlspecialchars($us1_3B);?></textarea></center>
</td>
</tr>

<tr>
<td>
<font face="Verdana" size="2">Honourable</font>
<center>
<?php  $us3_3B = isset($_REQUEST['us3_3B']) ? $_REQUEST['us3_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us3_3B"><?php print htmlspecialchars($us3_3B);?></textarea></center>
</td>
</tr>
...
<td>
<font face="Verdana" size="2">dated</font>
<?php  $dated_3B = isset($_REQUEST['dated1_3B']) ? $_REQUEST['dated1_3B'] :''; ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
<td>
<font face="Verdana" size="2">taken out by </font>
<center>
<?php  $presented_3B = isset($_REQUEST['presented_3B']) ? $_REQUEST['presented_3B'] :''; ?>
<textarea rows="2"   cols="55" name="presented_3B"><?php print htmlspecialchars($presented_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">affidavit(s) of </font>
<center>
<?php  $bench_3B = isset($_REQUEST['bench_3B']) ? $_REQUEST['bench_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench_3B"><?php print htmlspecialchars($bench_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Son of</font>
<center>
<?php  $us1_3B = isset($_REQUEST['us1_3B']) ? $_REQUEST['us1_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us1_3B"><?php print htmlspecialchars($us1_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">aged</font>
<center>
<?php  $us2_3B = isset($_REQUEST['us2_3B']) ? $_REQUEST['us2_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us2_3B"><?php print htmlspecialchars($us2_3B);?></textarea></center>
</td>
</tr>
...
<tr>
<td>
<font face="Verdana" size="2">residing at</font>
<center>
<?php  $us3_3B = isset($_REQUEST['us3_3B']) ? $_REQUEST['us3_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us3_3B"><?php print htmlspecialchars($us3_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">director/secretary/</font>
<center>
<?php  $bench_3B = isset($_REQUEST['bench_3B']) ? $_REQUEST['bench_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench_3B"><?php print htmlspecialchars($bench_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Company name</font>
<center>
<?php  $presented_3B = isset($_REQUEST['presented_3B']) ? $_REQUEST['presented_3B'] :''; ?>
<textarea rows="2"   cols="55" name="presented_3B"><?php print htmlspecialchars($presented_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">paragraphs</font>
<center>
<?php  $us4_3B = isset($_REQUEST['us4_3B']) ? $_REQUEST['us4_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us4_3B"><?php print htmlspecialchars($us4_3B);?></textarea></center>
</td>
</tr>
...
<font face="Verdana" size="2">paragraphs</font>
<center>
<?php  $us5_3B = isset($_REQUEST['us5_3B']) ? $_REQUEST['us5_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us5_3B"><?php print htmlspecialchars($us5_3B);?></textarea></center>
</td>
</tr>
...
<tr>
<td>
<font face="Verdana" size="2">For</font>
<center>
<?php  $us1_3B = isset($_REQUEST['us1_3B']) ? $_REQUEST['us1_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us1_3B"><?php print htmlspecialchars($us1_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Directors/a director/</font>
<center>
<?php  $us3_3B = isset($_REQUEST['us3_3B']) ? $_REQUEST['us3_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us3_3B"><?php print htmlspecialchars($us3_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">I have been a</font>
<center>
<?php  $us4_3B = isset($_REQUEST['us4_3B']) ? $_REQUEST['us4_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us4_3B"><?php print htmlspecialchars($us4_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">paragraph 1 to</font>
<center>
<?php  $presented_3B = isset($_REQUEST['presented_3B']) ? $_REQUEST['presented_3B'] :''; ?>
<textarea rows="2"   cols="55" name="presented_3B"><?php print htmlspecialchars($presented_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">provision of section</font>
<center>
<?php  $bench_3B = isset($_REQUEST['bench_3B']) ? $_REQUEST['bench_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench_3B"><?php print htmlspecialchars($bench_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Amount of fees</font>
<center>
<?php  $bench1_3B = isset($_REQUEST['bench1_3B']) ? $_REQUEST['bench1_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench1_3B"><?php print htmlspecialchars($bench1_3B);?></textarea></center>
</td>
</tr>

<tr>
<td>
<font face="Verdana" size="2">Name of the Bank</font>
<center>
<?php  $bench2_3B = isset($_REQUEST['bench2_3B']) ? $_REQUEST['bench2_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench2_3B"><?php print htmlspecialchars($bench2_3B);?></textarea></center>
</td>
</tr>

<tr>
<td>
<font face="Verdana" size="2">Demand draft number</font>
<center>
<?php  $bench3_3B = isset($_REQUEST['bench3_3B']) ? $_REQUEST['bench3_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench3_3B"><?php print htmlspecialchars($bench3_3B);?></textarea></center>
</td>
</tr>

<tr>
<td>
<font face="Verdana" size="2">List of enclosures</font>
<center>
<?php  $bench4_3B = isset($_REQUEST['bench4_3B']) ? $_REQUEST['bench4_3B'] :''; ?>
<textarea rows="2"   cols="55" name="benc4_3B"><?php print htmlspecialchars($bench4_3B);?></textarea></center>
</td>
</tr>
...
<?php  $dated1_3B = isset($_REQUEST['dated1_3B']) ? $_REQUEST['dated1_3B'] :''; ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" id="dated1_3B"  autocomplete="off" size="20" maxlength="10" name="dated1_3B" value="<?php print htmlspecialchars($dated1_3B); ?>" onKeyup="javascript:addNumbers7(this.value)" onFocus="SetBg(this)" />
</td>
</tr>

<tr>
<td>
<font face="Verdana" size="2">before me at </font>
<center>
<?php  $bench5_3B = isset($_REQUEST['bench5_3B']) ? $_REQUEST['bench5_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench5_3B"><?php print htmlspecialchars($bench5_3B);?></textarea></center>
</td>
</tr>
...
<?php  $dated2_3B = isset($_REQUEST['dated2_3B']) ? $_REQUEST['dated2_3B'] :''; ?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" id="dated2_3B"  autocomplete="off" size="20" maxlength="10" name="dated2_3B" value="<?php print htmlspecialchars($dated2_3B); ?>" onKeyup="javascript:addNumbers7(this.value)" onFocus="SetBg(this)" />
</td>
</tr>
...
<tr>
<td>
<font face="Verdana" size="2">IN THE MATTER OF</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Name and address of the Depositor/Debenture holder-applicant</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Name of the company and address of its Registered Office</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Name(s) of Depositor (s)/ company Debenture holder/ Debenture Trustee (s) with full address</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Amount of Deposits</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Fixed Deposit / Debenture Receipt No. & date</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Terms and Conditions </font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Details of payment made</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Actual amount due as on date of application (Principal/interest)</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Details of correspondence, if any, made between the company and the Depositor</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Any other particular(s)</font>
<center>
<?php  $presented_3B = isset($_REQUEST['presented_3B']) ? $_REQUEST['presented_3B'] :''; ?>
<textarea rows="2"   cols="55" name="presented_3B"><?php print htmlspecialchars($presented_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Place</font>
<center>
<?php  $bench_3B = isset($_REQUEST['bench_3B']) ? $_REQUEST['bench_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench_3B"><?php print htmlspecialchars($bench_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Read over/translated into</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<font face="Verdana" size="2">place</font>
<center>
<?php  $pl_3B = isset($_REQUEST['pl_3B']) ? $_REQUEST['pl_3B'] :''; ?>
<textarea rows="2"   cols="55" name="pl_3B"><?php print htmlspecialchars($pl_3B);?></textarea></center>
</td>
</tr>
...
<tr>
<td>
<font face="Verdana" size="2">Between</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Legal Representative</font>
<center>
<?php  $lr_3B = isset($_REQUEST['lr_3B']) ? $_REQUEST['lr_3B'] :''; ?>
<textarea rows="2"   cols="55" name="lr_3B"><?php print htmlspecialchars($lr_3B);?></textarea></center>
</td>
</tr>

<tr>
<td>
<font face="Verdana" size="2">Respondent/s</font>
<center>
<?php  $us1_3B = isset($_REQUEST['us1_3B']) ? $_REQUEST['us1_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us1_3B"><?php print htmlspecialchars($us1_3B);?></textarea></center>
</td>
...
<font face="Verdana" size="2">Legal Representative</font>
<center>
<?php  $lr1_3B = isset($_REQUEST['lr1_3B']) ? $_REQUEST['lr1_3B'] :''; ?>
<textarea rows="2"   cols="55" name="lr1_3B"><?php print htmlspecialchars($lr1_3B);?></textarea></center>
</td>
</tr>
...
<tr>
<td>
<font face="Verdana" size="2">Father’s /Mother’s/Husband’s Name</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Age</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Occupation</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Place of Residence and address</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Name of the Officer administering the Oath/affirmation</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Name of the Interpreter </font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Cross-examination By</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
<tr>
<td>
<font face="Verdana" size="2">Re-examination, if any</font>
<center>
<?php  $us_3B = isset($_REQUEST['us_3B']) ? $_REQUEST['us_3B'] :''; ?>
<textarea rows="2"   cols="55" name="us_3B"><?php print htmlspecialchars($us_3B);?></textarea></center>
</td>
...
if($notice_type==8)
{
	...
	<font face="Verdana" size="2">Name</font>
	<center>
	<?php  $name_a = isset($_REQUEST['name_a']) ? $_REQUEST['name_a'] :''; ?>
	<textarea rows="2"   cols="55" name="name_a" ><?php print htmlspecialchars($name_a);?></textarea>
	</td>
	</tr>
	<tr>
	<td>
	<font face="Verdana" size="2">Age</font>
	<center>
	<?php  $age_a = isset($_REQUEST['age_a']) ? $_REQUEST['age_a'] :''; ?>
	<input type ="text" name="age_a" value="<?php print htmlspecialchars($age_a);?>">
	...
	<font face="Verdana" size="2">Residing at</font>
	<center>
	<?php  $residing = isset($_REQUEST['residing']) ? $_REQUEST['residing'] :''; ?>
	<textarea rows="2"   cols="55" name="residing" ><?php print htmlspecialchars($residing);?></textarea>
	</center>
	...
	<tr>
	<td>
	<font face="Verdana" size="2">I am a director/secretary</font>
	<center>
	<?php  $desig = isset($_REQUEST['desig']) ? $_REQUEST['desig'] :''; ?>
	
	<textarea rows="2"   cols="55" name="desig" ><?php print htmlspecialchars($desig);?></textarea>
	</center>
	...
	<tr>
	<td>
	<font face="Verdana" size="2">Organation</font>
	<center>
	<?php  $company_at = isset($_REQUEST['company_at']) ? $_REQUEST['company_at'] :''; ?>
	<textarea rows="2"   cols="55" name="company_at" ><?php print htmlspecialchars($company_at);?></textarea>
...
if($notice_type==11)
{
	...
	<tr>
	<td align="left">
	<font face="Verdana" size="2">Name (intern above named)</font>
	<center>
	<?php  $name_a = isset($_REQUEST['name_a']) ? $_REQUEST['name_a'] :''; ?>
	<textarea rows="2"   cols="55" name="name_a" ><?php print htmlspecialchars($name_a);?></textarea>
	</td>
	...
	<tr>
	<td align="left">
	<font face="Verdana" size="2">Name (Authorized Representative)</font>
	<center>
	<?php  $name_ab = isset($_REQUEST['name_ab']) ? $_REQUEST['name_ab'] :''; ?>
	<textarea rows="2"   cols="55" name="name_ab" ><?php print htmlspecialchars($name_ab);?></textarea>
	</td>
	</tr>
	
	<tr>
	<td>
	<font face="Verdana" size="2">Practicing as  </font>
	<center>
	<?php  $residing = isset($_REQUEST['residing']) ? $_REQUEST['residing'] :''; ?>
	<textarea rows="2"   cols="55" name="residing" ><?php print htmlspecialchars($residing);?></textarea>
	</center>
	...
	<tr>
	<td>
	<font face="Verdana" size="2">Registration No.</font>
	<center>
	<?php  $age_a = isset($_REQUEST['age_a']) ? $_REQUEST['age_a'] :''; ?>
	<input type ="text" name="age_a" value="<?php print htmlspecialchars($age_a);?>">
	...
	<font face="Verdana" size="2">Practicing as  </font>
	<center>
	<?php  $practic = isset($_REQUEST['practic']) ? $_REQUEST['practic'] :''; ?>
	<textarea rows="2"   cols="55" name="practic" ><?php print htmlspecialchars($practic);?></textarea>
	</center>
	...
	<tr>
	<td>
	<font face="Verdana" size="2">Rolls of </font>
	<center>
	<?php  $roll_as = isset($_REQUEST['roll_as']) ? $_REQUEST['roll_as'] :''; ?>
	<textarea rows="2"   cols="55" name="roll_as" ><?php print htmlspecialchars($roll_as);?></textarea>
	</center>
	...
	<tr>
	<td>
	<font face="Verdana" size="2">AT</font>
	<center>
	<?php  $desig = isset($_REQUEST['desig']) ? $_REQUEST['desig'] :''; ?>
	...
	<tr>
	<td>
	<font face="Verdana" size="2">Address with contact no and valid email </font>
	<center>
	<?php  $company_at = isset($_REQUEST['company_at']) ? $_REQUEST['company_at'] :''; ?>
	<textarea rows="2"   cols="55" name="company_at" ><?php print htmlspecialchars($company_at);?></textarea>
	...
	<tr>
	<td>
	<font face="Verdana" size="2">Cancellation of the registration of the said </font>
	<center>
	<?php  $cal = isset($_REQUEST['cal']) ? $_REQUEST['cal'] :''; ?>
	<textarea rows="2"   cols="55" name="cal" ><?php print htmlspecialchars($cal);?></textarea>
	...
	<font face="Verdana" size="2">Date</font>
	<center>
	<?php  $todate= isset($_REQUEST['todate']) ? $_REQUEST['todate'] :date('d/m/Y'); ?>
	<textarea rows="2"   cols="55" name="todate" ><?php print htmlspecialchars($todate);?></textarea>
	...
	<font face="Verdana" size="2">Place </font>
	<center>
	<?php  $place = isset($_REQUEST['place']) ? $_REQUEST['place'] :''; ?>
	<textarea rows="2"   cols="55" name="place" ><?php print htmlspecialchars($place);?></textarea>
	...
	<tr>
	<td>
	<font face="Verdana" size="2">To the Registrar of the Tribunal </font>
	<center>
	<?php  $toadd = isset($_REQUEST['toadd']) ? $_REQUEST['toadd'] :''; ?>
	<textarea rows="2"   cols="55" name="toadd" ><?php print htmlspecialchars($toadd);?></textarea>
...
<tr>
<td>
<font face="Verdana" size="2">on behalf of  </font>
<center>
<?php  $presented_3B = isset($_REQUEST['presented_3B']) ? $_REQUEST['presented_3B'] :''; ?>
<textarea rows="2"   cols="55" name="presented_3B"><?php print htmlspecialchars($presented_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">petitioner/ opposite party/Registrar/ Regional Director/Government of </font>
<center>
<?php  $bench_3B = isset($_REQUEST['bench_3B']) ? $_REQUEST['bench_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench_3B"><?php print htmlspecialchars($bench_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">day of 
</font><center>
<?php  $place_3B = isset($_REQUEST['place_3B']) ? $_REQUEST['place_3B'] :''; ?>
<textarea rows="2"   cols="55" name="place_3B"><?php print htmlspecialchars($place_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2"> presented by </font>
<center>
<?php  $presented_3B = isset($_REQUEST['presented_3B']) ? $_REQUEST['presented_3B'] :''; ?>
<textarea rows="2"   cols="55" name="presented_3B"><?php print htmlspecialchars($presented_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2"> before </font>
<center>
<?php  $bench_3B = isset($_REQUEST['bench_3B']) ? $_REQUEST['bench_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench_3B"><?php print htmlspecialchars($bench_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">applicant is</font>
<center>
<?php  $state_3B = isset($_REQUEST['state_3B']) ? $_REQUEST['state_3B'] :''; ?>
<textarea rows="2"   cols="55" name="state_3B"><?php print htmlspecialchars($state_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">petitioner are  </font>
<center>
<?php  $before_3B = isset($_REQUEST['before_3B']) ? $_REQUEST['before_3B'] :''; ?>
<textarea rows="2"   cols="55" name="before_3B"><?php print htmlspecialchars($before_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">Bench on 
</font><center>
<?php  $place_3B = isset($_REQUEST['place_3B']) ? $_REQUEST['place_3B'] :''; ?>
<textarea rows="2"   cols="55" name="place_3B"><?php print htmlspecialchars($place_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">grounds: 
</font><center>
<?php  $applicant_3B = isset($_REQUEST['applicant_3B']) ? $_REQUEST['applicant_3B'] :''; ?>
<textarea rows="2"   cols="55" name="applicant_3B"><?php print htmlspecialchars($applicant_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">relief 
</font><center>
<?php  $filing_party = isset($_REQUEST['filing_party']) ? $_REQUEST['filing_party'] :''; ?>
<textarea rows="2"   cols="55" name="filing_party"><?php print htmlspecialchars($filing_party);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2"> Certified that  </font>
<center>
<?php  $presented_3B = isset($_REQUEST['presented_3B']) ? $_REQUEST['presented_3B'] :''; ?>
<textarea rows="2"   cols="55" name="presented_3B"><?php print htmlspecialchars($presented_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2"> witness/in/No </font>
<center>
<?php  $bench_3B = isset($_REQUEST['bench_3B']) ? $_REQUEST['bench_3B'] :''; ?>
<textarea rows="2"   cols="55" name="bench_3B"><?php print htmlspecialchars($bench_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">of 20 </font>
<center>
<?php  $state_3B = isset($_REQUEST['state_3B']) ? $_REQUEST['state_3B'] :''; ?>
<textarea rows="2"   cols="55" name="state_3B"><?php print htmlspecialchars($state_3B);?></textarea></center>
...
<tr>
<td>
<font face="Verdana" size="2">this  </font>
<center>
<?php  $before_3B = isset($_REQUEST['before_3B']) ? $_REQUEST['before_3B'] :''; ?>
<textarea rows="2"   cols="55" name="before_3B"><?php print htmlspecialchars($before_3B);?></textarea></center>
