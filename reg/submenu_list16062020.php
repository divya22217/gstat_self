...
$users_query = $db->prepare("select count(*) as count from submenu_r");
$users_query->execute();
...
<head>
    ...
    <script type="text/javascript" src="../master1/js/angularjs/submenu_list.js"></script>
	<style>
		table, td, th {
...
<div class="wrapper">
    ...
    <div class="margin-top-30">
        <div ng-controller="submenus" data-ng-init="submenuInformation()">           
             <div class="col-md-12">
                <div class="row add_panel"><h4><b> Sub Menu List (Total - <span color="red"><?php echo $count;?></span>)</b></h4></div>
            </div>
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table datatable="ng" id="examples" class="table table-striped table-bordered" cellspacing="0"
                        ...
                        <tbody>
                            <tr ng-repeat="submenu in submenu_list">
                                <td>{{$index + 1}}</td>
                                <td>{{submenu.submenu_name}}</td>
                                <td>
                                    <a href="javascript:void(0);" ng-click="EditModal(submenu);" title='Edit' id="submenu.submenu_id">
                                        <i class="glyphicon glyphicon-edit"></i>
                                    </a> &nbsp;&nbsp;&nbsp;
									
                                     <a href="javascript:void(0);" ng-if="submenu.display == true" title='Delete' ng-click="DeleteModal(submenu)" class="delete">
                                        <i class="glyphicon glyphicon-trash"></i>
                                    </a>
									<a href="javascript:void(0);" ng-if="submenu.display == false" title='Restore' ng-click="RestoreModal(submenu)" class="restore">
            ...
            <div id="form_modal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog">
                <div class="modal-dialog ">
                    <div class="modal-content">
                        ...
                        <!-- Form inside modal -->
						<form method="post" ng-submit="MenuAddUpdate(submenus_form);" id="submenus_form_id">
                            <div class="modal-body with-padding">
                                <input type="hidden" name="action_text" id="action_text"
                                    ng-model="submenus_form.action" value="update">
                                <input type="hidden" name="id" ng-model="submenus_form.id" id="id">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label>Sub Menu Name :</label>
                                            <input type="text" name="short_name" ng-model="submenus_form.submenu_name"
                                             id="submenu_name" required="required" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
