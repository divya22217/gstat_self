...
{
header("Location:change_pass1.php?msg=1&ipq=$keyss");
die();
}
if($new_password !=$confirm_new_password)
{
header("Location:change_pass1.php?msg=2&ipq=$keyss");
die();
}
...
if($oll !='')
{
	header("Location:change_pass1.php?msg=4&ipq=$keyss");
	die();
}
...
header("Location:change_pass1.php?msg=3&ipq=$keyss");
die("Password Not Changed .... ");
}
}
