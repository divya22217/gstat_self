                            ...
                            <div class="modal-body with-padding">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <label> Court : </label>
                                                <select name="court" ng-model="users_form.court" id="court"
                                                class="form-control">
                                                    <?php
                                                        ...
                                                        while ($result = $selected_court_sql->fetch(PDO::FETCH_ASSOC, PDO::FETCH_ORI_NEXT)) {
                                                            print "<option value=".htmlspecialchars($result['court_no']).">" . htmlspecialchars(ucwords(strtoupper($result['display_court_text']))) . "</option>";
                                                        }
                                                        ?>
                                                </select>
                                        </div>
