	...
	<head>
		<script language="javascript">
			...
			function submitForm1() {
				with(document.frm) {
					// console.log('location',$('select[name=location]').val())
					// console.log('location',$('input[name=designation]').val())
					// console.log('location',$('input[name=first_name]').val())
					// console.log('location',$('input[name=email_id]').val())
					// console.log('location',$('input[name=password]').val())
					// console.log('location',$('input[name=conf_password]').val())
			...
			if (isset($_REQUEST['registeruser'])) {
				...
				if ($first_name != '' || $username != '' || $email_id != '' || $designation != '' || $password != '' || $conf_password != '') {
					...
					if (strlen($password) != '64') {
						echo '<h2><center>Password not valid </center></h2>';
						die();
					}
					if (strlen($conf_password) != '64') {
						echo '<h2><center>Password not valid </center></h2>';
						die();
					}
