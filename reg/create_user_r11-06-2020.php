...
if($localadmin == '1'){
	...
	$create_user_sql =$db->prepare("insert into public.users_cis (username, password, salt, email, gender, location, fname, lname, pwd_hash, main_id, login_status, schema_id, user_creation_date, localadmin, menuaccess_codeall, user_type) values ('$username','$password','$salt_sat','$email_id','$gender','$location','$first_name','$last_name','$pwd_hash','$main_id','$login_status','$schema_id','$user_creation_date','$localadmin','$designation','$user_type')");
