...
?>
                        <tr>
                            <td align="right" colspan="4" style="padding-bottom:1em;"><span><font color="red">*</font></span><b>LOCATION: </b></td>
                               ...
                               <select name="location" onchange="javascript:select_menu();" >
                                    ...
                                    $select_menu_sql = $db->prepare("select bench_name, city_id from public.mater_location_bench order by city_id asc");
                                    $select_menu_sql->execute();
                                    while ($select_menu_sql_result = $select_menu_sql->fetch(PDO::FETCH_ASSOC,PDO::FETCH_ORI_NEXT))
                                    {
																								print "<option value=".htmlspecialchars($select_menu_sql_result['city_id']).">".htmlspecialchars(ucwords(strtoupper($select_menu_sql_result['bench_name'])))."</option>";
																		}
...
<?php if($localadmin == '1') {?>
	...
	<tr>
	    <td align="right" colspan="4" style="padding-bottom:1em;"><span><font color="red">*</font></span><b>LOCATION: </b></td>
	       ...
	       <select name="location" onchange="javascript:select_menu();" >
	          <?php
	  $selected_loc_sql = $db->prepare("select bench_name, city_id from public.mater_location_bench where city_id=?");
	  ...
	  {
	              print "<option value=".htmlspecialchars($selected_loc_sql_result['city_id'])." selected>".htmlspecialchars(ucwords(strtoupper($selected_loc_sql_result['bench_name'])))."</option>";
	  ...
	  ?>
														...
														<tr>
														                        <td align="right" colspan="4" style="padding-bottom:1em;"><span><font color="red">*</font></span><b>DESIGNATION:</b>
														                        </td>
														                        <td align="left" colspan="6" style="padding-bottom:1em;">
...
<tr>
                        <td align="right" colspan="4" style="padding-bottom:1em;"><span><font color="red">*</font></span><b>FIRST NAME:</b>
                        </td>
						 <td align="left" colspan="6" style="padding-bottom:1em;">
						...
						<tr>
                        <td align="right" colspan="4" style="padding-bottom:1em;"><span><font color="red">*</font></span><b>USERNAME:</b>
                        </td>
						 <td align="left" colspan="6" style="padding-bottom:1em;">
						 ...
						 <input type="text" name="username"><br>
							...
							<tr>
                        <td align="right" colspan="4" style="padding-bottom:1em;"><span><font color="red">*</font></span><b>E-MAIL ID:</b>
                        </td>
						 <td align="left" colspan="6" style="padding-bottom:1em;">
...
<tr>
                        ...
                        <td align="right" colspan="4" style="padding-bottom:1em;"><b>MOBILE No.:</b>
						 ...
						 <input type="text" name="mob_no"><br>
															...
															<tr>
                        <td align="right" colspan="4" style="padding-bottom:1em;"><span><font color="red">*</font></span><b>PASSWORD:</b>
                        </td>
						 <td align="left" colspan="6" style="padding-bottom:1em;">
						 <input type="password" name="password"><br>
															...
															<tr>
                        <td align="right" colspan="4" style="padding-bottom:1em;"><span><font color="red">*</font></span><b>CONFIRM PASSWORD:</b>
                        </td>
						 <td align="left" colspan="6" style="padding-bottom:1em;">
...
if($localadmin == '1'){
	...
	$create_user_sql =$db->prepare("insert into public.users_cis (username, password, salt, email, gender, location, fname, lname, pwd_hash, main_id, login_status, schema_id, user_creation_date, localadmin, menuaccess_codeall, user_type, mobile_no) values ('$username','$password','$salt_sat','$email_id','$gender','$location','$first_name','$last_name','$pwd_hash','$main_id','$login_status','$schema_id','$user_creation_date','$localadmin','$designation','$user_type', '$mob_no')");
