...
<li class="active"><a href="./purpose_master.php">ADD NEW </a></li>
</ol>
</section>
...
<tbody>
<?php 
$sth = $db->prepare("select * from $schemas.master_purpose where display='TRUE' order by purpose_priority ASC");
$sth->execute();
if($sth->rowCount()==0){
?>                
<tr>
...
<td><?php echo $row[purpose_name];?></td>
 <td><a href="purpose_master.php?y_id=<?php echo $row[purpose_code];?>"><i class="fa fa-edit"></i></a></td>
</tr>
<?php 
$sr_no++;
}
