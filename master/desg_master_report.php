...
<tbody>
<?php 
$sth = $db->prepare("select * from $schemas.master_desg where display='TRUE' order by desg_name ASC");
$sth->execute();
if($sth->rowCount()==0){
?>                
<tr>
...
<td><?php echo $row[desg_name];?></td>
 <td><a href="desg_master.php?y_id=<?php echo $row[desg_code];?>"><i class="fa fa-edit"></i></a></td>
</tr>
<?php 
$sr_no++;
}
