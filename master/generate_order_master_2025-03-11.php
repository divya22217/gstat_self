...
//   apl-04 start
        ...
        if(($case_status == 'D' && ($case_type_appeal == '1' || $case_type_appeal == '11')) || (!empty($case_disposal_data) && $case_disposal_data['disposal_nature'] == '46')) {
