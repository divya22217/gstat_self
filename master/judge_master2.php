...
<!-- /.box-header -->
<!-- form start -->
<form name="frm" method="post" action="judge_master_action.php" onSubmit="return validate();">
...
<div class="box-body">
    <div class="form-group">
        ...
        <select name="judeg_desg_code"  class="form-control" >
            <?php
...
<input type="text" class="form-control" id="" placeholder="" name="judge_name" value="<?php echo $judge_name;?>">
</div>
</div>
<!-- /.box-body -->
