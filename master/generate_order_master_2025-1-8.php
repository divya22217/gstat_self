...
//   apl-04 start
        ...
        if(($case_status == 'D' && $case_type_appeal == '1') || (!empty($case_disposal_data) && $case_disposal_data['disposal_nature'] == '46')) {
                $query = "select personal_hearing,brief_order,order_status,det_amount_tax,det_amount_interest,det_amount_penalty,det_amount_fees,det_amount_others,det_amount_refund,demand_quantified,authority_name,direction_subject,remand_order,order_ref_no from $schemas.order_daily where filing_no  =?  and order_date = ? order by item_no desc limit 1";
                ...
                $pdf_html .= '<div class="row red"> <div class="col-md-12"> <div class="text-center"><p>Form GST APL-04A</p> <p>[See rules 113(1) & 115]</p> <p>Summary of the demand after issue of order by the Appellate Authority, Tribunal or Court</p> </div> </div><table style="line-height: 1.2; margin-bottom: 15px; margin-top: 10px; width: 100%;"><tbody><tr><td style="vertical-align: top; width: 60%;""><b>Is it remand order :</b> <span>'.$remand_order.'</span></td></tr><tr><td style="vertical-align: top; width: 60%;"><b>Order no. :</b> <span>'.$order_ref_no.'</span></td><td style="vertical-align: top; text-align: right;"><b>Date of order :</b> <span>'.$next_list_dateold.'</span></td></tr></tbody></table> <div class="col-md-12"> <table border="1" cellpadding="5" style="line-height: 1.2; margin-bottom: 15px; margin-top: 5px; width: 100%; border-collapse: collapse;"> <tbody> <tr> <td><b>1.</b></td> <td colspan="3">GSTIN/Temporary ID/UIN - <span>'. $gst_no.'</span> </td> </tr> <tr> <td><b>2.</b></td><td>Appeal Case Reference no. - <span>APL/4/2024</span></td><td colspan="2">Date - <span>21/08/2024</span></td></tr><tr><td><b>3.</b></td><td colspan="3">Name of the appellant - <span>'.$applicant_name. ' , ' .$applicant_email. ' , ' .$applicant_mobile.'</span> </td> </tr> <tr> <td><b>4.</b></td> <td colspan="3">Name of the respondant - <span>'.$respondent_name. ' , ' .$respondent_email. ' , ' .$respondent_mobile.'</span> </td> </tr> <tr> <td><b>5.</b></td> <td colspan="3">Order appealed against - <span>'.$crn_number.'</span> </td></tr><tr><td></td><td colspan="3"><b>(5.1)</b> <b>Order appealed against -</b> <span>'.$order_number.'</span> </td> </tr><tr><td></td><td colspan="2"><b>(5.2)</b> <b>Ref Number -</b> <span>'.$order_number.'</span> </td> <td>Date - <span>'.$order_date.'</span></td> </tr><tr><td><b>6.</b></td> <td colspan="3">Personal Hearing -  '.$hearing_dates_all.'</td> </tr> '.$order_status_html.' <tr> <td><b>8.</b></td> <td colspan="3">Order in brief - '.$brief_order.'</td> </tr><tr><td colspan="4" style="text-align:center; font-size:18px;"><b>Summary of Order</b></td></tr>  <tr> <td><b>9.</b></td> <td colspan="3">If demand order then whether demand quantified: '.$demand_quantified.'</td> </tr></tbody></table>'.$demand_quantified_html.'<table border="1" cellpadding="5" style="line-height: 1.2; margin-bottom: 15px; margin-top: 10px; width: 100%; border-collapse: collapse;"><tr>   <td><b>10.</b></td> <td colspan="10">For Other orders and Demand orders which are not quantified:</td></tr><tr> <td colspan="3">Issues as raised by proper officer</td> <td colspan="4">Issues as determined by Appellate/Revisional authority</td> <td colspan="4">Order by GST Appellate Tribunal</td></tr> '.$gst_summary_html.$remand_order_html.'</tbody></table><table style="line-height: 1.2; margin-bottom: 15px; margin-top: 10px; width: 100%;"><tr><td valign="top" style="vertical-align: top; width: 50%;">  <p>Place :'.strtoupper($schemas).'</p> <p>Date :</p></td><td valign="top" style="text-align: right;"> <p><span>Signature</span></p> <p><span>'.strtoupper($schemas).'  '.$user_actual_name.'</span></p> <p><span>Designation : '.$desgignation.'</span></p> <p><span>Jurisdiction :</span></p> </td></tr></table></div> </div><div style="page-break-before:always"></div>';
        } 
