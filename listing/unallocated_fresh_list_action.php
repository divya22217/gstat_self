...
if($cnt==0)
{
  ...
  $newst7 ="update $schemas.case_detail set legal_aid ='A',court_no='$c_no',location_code ='$location_code',res_occupation='L' where filing_no='$filing_no' ";
 ...
 $db->query($newst7) or die("case no not updated");   
  ...
  $insert ="insert into $schemas.case_allocation_temp(filing_no,listing_date,purpose,entry_date,deal_cd,connected,priority_serial,bench_nature,bench_no,
		 court_no,list_flag,listed,list_criteria,form_status) values('$filing_no','$listt_date','$purpose_id','$server_date','$sessionUserType','N','999','$b_nature','$bench_no','$c_no','1','1','O','UF')";
...
header("Location:./unallocated_fresh_list.php?msghash=$msghash");
