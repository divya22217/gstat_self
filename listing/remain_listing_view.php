...
$sql=$db->prepare("select count(*) from $schemas.case_allocation_temp where listing_date='$list_date' ");
...
$sql1=$db->prepare("select * from $schemas.case_allocation_temp where listing_date=? ");
