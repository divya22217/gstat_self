...
if($cnt==0)
{
 ...
 $db->query($newst7) or die("case no not updated");   
  ...
  $insert ="insert into $schemas.case_allocation_temp(filing_no,listing_date,purpose,entry_date,deal_cd,connected,priority_serial,bench_nature,bench_no,
		 court_no,list_flag,listed,list_criteria,form_status) values('$filing_no','$listt_date','$purpose_id','$server_date','$sessionUserType','N','999','$b_nature','$bench_no','$c_no','1','1','N','F')";
...
header("Location:./fresh_listing.php?msghash=$msghash");
