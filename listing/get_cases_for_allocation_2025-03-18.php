...
if($_SESSION['user'] !='' && $_SESSION['location'] !='')
{
	...
	if($type == 'all_cases' || $type == 'by_court_and_listing_date' || $type == 'reset_cases' || $type == 'case_no_search') {
		...
		<tr>
			...
			<td><input class="checkbox cases" data-list_with_defect = "<?php echo $lwd; ?>" name="checkbox[]" type="checkbox" id="checkbox_<?php echo $filing_no; ?>" value="<?php echo $filing_no; ?>" ></td>
