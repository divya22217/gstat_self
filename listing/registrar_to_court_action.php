...
$sessionUserType=htmlspecialchars($_SESSION['id']);
 ...
 $checkbox=$_REQUEST['checkbox'];
  $list_court=$_REQUEST['list_court'];
...
*/	
  ...
  $newst7 ="update $schemas.case_detail set legal_aid ='A',court_no='$list_court',registrar_date='$server_date' where filing_no='$filing_no' ";
 ...
 $db->query($newst7) or die("case no not updated");   
  ...
  $insert ="insert into $schemas.case_allocation_temp(filing_no,listing_date,purpose,entry_date,deal_cd,connected,priority_serial,bench_nature,bench_no,
		 court_no,list_flag,listed) values('$filing_no','$listt_date','$purpose_id','$server_date','$sessionUserType','N','999','$b_nature','$bench_no','$c_no','1','1')";
...
$msg= "SUCCESSFULLY ALLOCATE TO COURT";
//$msghash1 =$msg."@".$listt_date;

$msghash1 =$msg;
$msghash=base64_encode($msghash1);
header("Location:./registrar_to_court.php?msghash=$msghash");
