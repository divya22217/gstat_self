...
$schemas = htmlspecialchars($_POST['schema_name']);

// At the top of the page we check to see whether the user is logged in or not
	$main_cases = main_case_type();
	$main_location_code = 1;
	//$list_flag=$_REQUEST["listtype"];
	$counttime = 0;
	$pagec = 1;
	$listbefore = $_REQUEST["list_before"];
	//$bench_code1=$_REQUEST["bench_code1"];
	$list_date = $_REQUEST['listing_date'];
	$court_no_remark = $court_no = $court_nono = $_POST['court_no'];
	$list_flag_remark = $list_flag = 1;
