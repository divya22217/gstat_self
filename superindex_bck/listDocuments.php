...
if ($security_code12 != '') {
    ...
    $strSchemaName = isset($_REQUEST['schema_name']) ? $_REQUEST['schema_name'] : 'lucknow';
        ...
        <table class="table table-bordered table-responsive table-hover" id="userTable">
            <thead style="background-color:#444444;color:#ffffff;">
                <tr class="row header" id="tableHeader">
                    ...
                    <th id="table_header_filed_by" class="cell" width="27%">Filed By</th>
                    <!-- <th id="table_header_filed_by" class="cell" width="27%">Purpose</th> -->
                     <th id="table_header_filed_by" class="cell" width="27%">Filed By</th>
                    <th class="cell" width="20%">Filing Date </th>
        ...
        function sendDocumentsListRequest(formData) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    console.log(documentDetailResponse);
                    ...
                    if (documentDetailResponse.error) {
                        ...
                        var strSuperIndexTitle = "<h2>Super Index for Filing No. " + filingNumber +
                        ...
                        if (0 == len || undefined == len || 'undefined' == len) {
                            ...
                            for (var i = 0; i < len; i++) {
                                ...
                                var filedByName = documentDetailResponse[i].filed_by_name ?
                                    documentDetailResponse[i].filed_by_name : '-';
                                ...
                                tr_str = "<tr class=\"row\"><td class=\"cell\" data-title=\"id\">" + id +
                                    ...
                                    "</td><td class=\"cell filed_by_value_column\" data-title=\"Document Owner\">" +
                                    titleCase(filedByName) + ' ' + filedByParty + "</td>" +
                                    "<td class=\"cell\" data-title=\"Filed By \">" + filedByName+
                                    "</td><td class=\"cell\" data-title=\"Filed Date\">" + formattedFilingDate +
                                    "</td>" +
                ...
                success: function(res) {
                    ...
                    items.forEach(item => {
                        item.addEventListener('click', () => {
                            ...
                            // getAllDocumentTypes(formData, arrstrDocOwners);
