            ...
            $courts = $st_party->fetchAll(); ?>
                    ...
                    <?php echo year_list(date('Y'), $start_from);
                        ...
                        $courts = $st_party->fetchAll(); ?>
                                    ...
                                    die;
                    } else if ($_POST['action'] == 'getRemarks') {

                        $filing_no_decode = base64_decode($_REQUEST['filing_no']);
                        ...
                        ?>
                        <div>
                            <div class="col-md-12 text-center text-danger" style="margin-bottom:20px; font-size: 16px; text-transform: uppercase;"><b><?php echo $pet_name; ?><br><span class="text-success">VS</span><br><?php echo $res_name; ?></b></div>
                            <div class="col-md-12"><b>Diary/Filing No.: <span class="text-success"><?php echo $filing_no_decode; ?></span></b></div>
                            <div class="col-md-12">
                                <div class="listview">
                                    <?php


                                    $remarks = getBORemarks($db, $filing_no_decode); ?>
