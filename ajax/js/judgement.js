...
//    $("#listing_case_detaisl").show();
    if (valid) {
        ...
        data['exact_search_word'] = $("#form_id_case_status #exact_search_word").val();
        data['text_name'] = $("#form_id_case_status #text_name").val();
