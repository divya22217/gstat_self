    ...
    ?>
        ...
        ?>
            ...
            $courts = $st_party->fetchAll(); ?>
                    ...
                    {
                        $st_party = $dbonline->prepare("SELECT distinct(a.rep_code), b.rep_name,b.bar_council_number FROM (select rep_code,display,party_flag,filing_no from e_more_representative
      UNION ALL select rep_code,display,party_flag,filing_no from e_more_representative_gst_nodal ) as a
    join e_master_advocate as b ON a.rep_code = b.id
