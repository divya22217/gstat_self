...
if($ccase == '2') {
				 ...
				 if($locode=='')
   {
	  ...
	  ?>		   
			  ...
			  <td>
<a  onclick="javascript::void(0);" style="cursor: pointer">
...
<font color="#900C3F" size="3">&nbsp;&nbsp;
  &nbsp;&nbsp;View</a>
	...
	<td colspan="5">
				...
				<a  target="_blank" href="http://efiling.nclat.gov.in/previewCIS.drt?filingNo=<?php echo $filing_no ?>"><font color="#900C3F" size="3">&nbsp;&nbsp;View
