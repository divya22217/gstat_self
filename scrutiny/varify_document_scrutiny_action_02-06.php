...
if($count_scrutiny >= 1)
	...
	$refiling_query = ", allow_refiling = 1";

	$st1x111 =$db->prepare("update document_upload set scrutiny = ? , display=? ,doc_level=?, defect_docs = ? $refiling_query where  miscellenous_no=? and scrutiny=? and display=? and doc_flag = ?");
...
$st1x111->bindParam(5, $miscellaneous_no, PDO::PARAM_STR);
$st1x111->bindParam(6, $scrutiny_dc, PDO::PARAM_STR);
$st1x111->bindParam(7, $display_dc, PDO::PARAM_STR);
$st1x111->bindParam(8, $doc_flag, PDO::PARAM_STR);
...
$kks='Y';
  	       ...
  	       $st13 =$db->prepare("update $schemas.scrutiny_doc set objection_status=?,compliance_date=?,defects=?,varifyed_userid=?,level_level=?, updated_at = now() , scrutiny_count=scrutiny_count+1 where miscellaneous_no=?");
...
$defective_html = '<!DOCTYPE html>
		       ...
		       <table style="line-height: 1.2; margin-bottom: 10px; margin-top: 10px; width: 100%;">
		            <tbody>
		                <tr>
		                    <td style="vertical-align: top; width: 60%;">
		                        <p style="line-height: 1.2; font-size: 19px;"><b>' . $pet_name1 . '</b></p>
		                    </td>
				...
				<table style="line-height: 1.2; margin-bottom: 10px; margin-top: 10px; width: 100%;">
		            <tbody>
		                <tr>
		                    <td style="vertical-align: top; width: 60%;">
		                        <p style="line-height: 1.2; font-size: 19px;"><b>' . $res_name1 . '</b></p>
		                    </td>
		                    <td style="vertical-align: top; text-align: right;">
		        ...
		        <div style="text-align: justify; margin-top: 30px;">
		            <p style="font-size: 18px; line-height: 1.4;"><b>To,<br> ' . $pet_name1 . '</b></p>
		            <p style="line-height: 1.4;">Subject- Appeal before Goods and services Tax Appellate Tribunal constituted under section 109 of the Central Goods and Services Tax Act, 2017 filed against the order no '.$order_no.' dated '.$order_date.' passed by Appellate/Revisional Authority under Section 107/108 of the Act-Regarding </p>
		                <p You are hereby informed that upon scrutiny of the above noted appeal/application filed by you in terms of rule ____ of the Goods and Services Tax Appellate Tribunal (Procedure) Rules, 2024, the following defects have been noted: -</p>
		            	<p style="color:red;text-align: center;">Defect List</p><table style="border-collapse: collapse; border: 2px solid black;">';
	...
	$defective_html .= '<tr style="border: 1px solid black;">
	        ...
	        <td style="border: 1px solid black;">'.$comment1.'</td>
	        </tr>';
	$sr++;
	}
	$comment1 = '';
	...
	$defective_html .= '<p>The aforesaid defects have also been communicated to you on the copy/link sent to you on your email/phone.</p>';
            ...
            <tbody>
                <tr>
                    ...
                    <td style="vertical-align: top; text-align: center;">
                        <p style="line-height: 1.4;"><b>Registrar/ Add Registrar/ Joint Registrar : '.$_SESSION['user_actual_name'].'<br><span style="white-space: nowrap; font-size: 14px;">GSTAT,</span><br> '.$_SESSION['bench_name'].' </b></p>
                    </td>
                </tr>
            </tbody>
        </table>
