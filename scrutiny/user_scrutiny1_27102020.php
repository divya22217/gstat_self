...
<a  onclick="OpenDMSForm('2','<?php echo $filing_no; ?>','<?php echo $E_nameP. ' VS ' . $E_nameR;?>','','','')" style="cursor: pointer">
...
<font color="#900C3F" size="3">&nbsp;&nbsp;
  &nbsp;&nbsp;View</a>
	...
	<td>
		<a  target="_blank" href="http://164.100.59.89/nclatonline/previewCIS.drt?filingNo=<?php echo $filing_no ?>"><font color="#900C3F" size="3">&nbsp;&nbsp;View </a>
	</td>
	<td>
	<a  target="_blank" href="http://164.100.59.89/nclatonline/previewReceipt.drt?filingNo=<?php echo $filing_no ?>"><font color="#900C3F" size="3">&nbsp;&nbsp;View</a>
	</td>
