...
<style type="text/css">
  ...
  <div class="content-wrapper">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="form-group">
							<input type="number" autocomplete="off" class="form-control" name="filing_no_search" id="filing_no_search" placeholder="Enter filing no">
						</div>
					</div>
				</div>
	...
	var end_date = $("#to_date").val();
	var item_per_page = $("#number_of_records").val(); */
	var filing_no = $("#filing_no_search").val();
	getdata('fn','','','','',url);
	}
	...
	function getdata(type,filing_no='',case_type,case_no,case_year,url='get_filed_document.php?page='){
