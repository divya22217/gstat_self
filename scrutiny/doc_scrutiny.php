...
cursor: pointer;">
					...
					<td width="20%">
						...
						<textarea class="comment" name="comment[]" onChange="makeUppercase(this)" cols="30" rows="1" data-id="<?php echo $id_check; ?>" id="comment_<?php echo $id_check; ?>" style="background-color: silver;"><?php echo $sc_comment; ?></textarea>
					</td>
