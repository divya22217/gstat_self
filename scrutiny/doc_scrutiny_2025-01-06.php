...
cursor: pointer;">
					...
					<td width="20%">
						...
						<textarea name="comment[]" onChange="makeUppercase(this)" cols="30" rows="1" style="background-color: silver;"><?php echo $sc_comment; ?></textarea>
					</td>
...
<form action="https://e-commcourt.gov.in/efilingGSTAT/CISCasePreview.drt" method="POST" target="_blank" id="previewCIS">
<input type="hidden" id="filling_no" name="filingNo" value="" />
</form>

<form action="https://e-commcourt.gov.in/efilingGSTAT/previewReceipt.drt" method="POST" target="_blank" id="previewReceipt">
