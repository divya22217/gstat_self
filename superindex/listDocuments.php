...
<div class="headinfo">
    <?php
    echo "Now: " . date("l jS \of F Y h:i:s A");
    ?>
</div>
        ...
        <table class="table table-bordered table-responsive table-hover" id="userTable">
            <thead style="background-color:#444444;color:#ffffff;">
                <tr class="row header" id="tableHeader">
                    ...
                    <th class="cell" width="17%">Upload Date</th>
                    ...
                    if (documentDetailResponse.error) {
                        ...
                        if (0 == len || undefined == len || 'undefined' == len) {
                            ...
                            for (var i = 0; i < len; i++) {
                                ...
                                var doc_upload_date=documentDetailResponse[i].doc_upload_date ?
                                    documentDetailResponse[i].doc_upload_date : '-';
                               ...
                               let UploadDate = convertToAMPMFormat(strUploadDate);
                                ...
                                tr_str = "<tr class=\"row\"><td class=\"cell\" data-title=\"id\">" + id +
                                    ...
                                    "</td><td class=\"cell\" data-title=\"Upload Date\">"+ UploadDate +
