...
?>
							...
							<a style="color:white !important;font-weight:bold;" target="_blank" href="./custom/verification_remarks.php?filing_no=<?php echo $filing_no_remark; ?>">
												Verified </a>
											</span>
										<?php }?>
										<br /><br />
				...
				if ($row['transfer_case_level'] == 4 && $row['is_transfered'] == true) { $filing_no_remark =base64_encode($filing_no);
?>
