								...
								<td>
									...
									<span><?php echo $main_case_for_backlog; ?><span>
											<h4>
												...
												<span class="label label-info">
													<a style="color: #FFFFFF;" onclick="ar_alert_fn('./scrutiny/level_two.php?ccase=<?php echo htmlspecialchars($c_case); ?>&filing_no_next=<?php echo htmlspecialchars($filing_no_send); ?>')" href="javascript:void(0)">Scrutiny </a>
												</span>
