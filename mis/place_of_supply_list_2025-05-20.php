			...
			if($selected_option == '3'){
						...
						if(!empty($total_records)){
							foreach($data as $key=>$value){
			                    ...
			                    <!--<a class="label label-danger" style="color: #FFFFFF;" href="javascript:void(0);" onClick="return reject_case('<?php echo $filing_no; ?>','<?php echo $case_type; ?>','../ajax/computation_note.php',5);" >Dismiss as Withdrawn as No Place of Supply dispute is involved</a>-->
								</td>
								</tr>
								<?php
								$count++;
