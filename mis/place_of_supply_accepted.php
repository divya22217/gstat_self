    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Place of supply accepted </h3>
...
function getdata(defect_status,radioValue,item_per_page,from_date,end_date,search_filing_no,url='place_of_supply_accepted_list.php?page=0'){
