    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Place of supply </h3>
  ...
  <?php echo htmlspecialchars($massage);?>
        ...
        <div class="box-body">
			...
			<div class="row">
				...
				<div class="col-sm-10">
					<label class="radio-inline">
				      <input type="radio" onChange="" value=1 name="select_option" checked>User Accepeted wrong place of supply cases
				    </label>
				    <label class="radio-inline">
				      <input type="radio" onChange="" value=2 name="select_option">No action taken by user
				    </label>
				    <label class="radio-inline">
				      <input type="radio" onChange="" value=3 name="select_option">User denies wrong place of supply cases
				    </label>
				</div>
			</div>
				<!--<div class="col-sm-2">
				...
				<!--<div class="col-sm-3">
					<div class="form-group">
						<label for="to_date" class="label-control col-sm-4">Filing No:</label>
						<div class="form-group">
							<input type="number" autocomplete="off"  name="search_filing_no" class="form-control" placeholder="Enter filing no" id="search_filing_no">
						</div>
					</div>
				</div>
			 ...
			 <div class="table-responsive">
                ...
                <table class="table table-hovered table-bordered no-margin"  id="case_list">
                  <thead>
					  ...
					  <th id="place_of_supply" style="display: none;">Applied for Place Of Supply</th>
					  <th>Action</th>
					  </tr>
                  </thead>
...
function getdata(defect_status,radioValue,item_per_page,from_date,end_date,search_filing_no,url='place_of_supply_list.php?page=0'){
	if(radioValue == '2')
