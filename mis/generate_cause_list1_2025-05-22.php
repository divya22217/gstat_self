...
<?php echo $CASE_NO ?> dddddd dddd</button></a>
											...
											<a onclick="OpenDMSForm('2','<?php echo $filing_no; ?>','<?php echo $pet_name . ' Vs ' . $res_name; ?>','<?php echo $case_numaa; ?>','<?php echo $court_no; ?>','','<?php echo $_SESSION['jwt_token'] ?>')" style="cursor: pointer">
