 ...
 if($case_type == '40'){
	...
	if($list_with_defect == '1'){
		 $CASE_NO = htmlspecialchars(' Listed With Defects '.display_filing_no($filing_no));
			...
			$CASE_NO = htmlspecialchars(strtoupper($case_type_short_name).' No. '.$case_num1aa.'/'.$lcodename.'/'.$case_year1aa);
		}
 }
...
<a  onclick="OpenDMSForm('2','<?php echo $filing_no; ?>','<?php echo $pet_name.' Vs ' .$res_name ;?>','<?php echo $case_numaa; ?>','<?php echo $court_no; ?>','')" style="cursor: pointer">
...
<?php }
	...
	<table  width="100%" border='0' cellpadding="1" cellspacing="3" align="center">
		...
		<tr><td></td><td><b>1 . Notice Board</b></td><td><b>By the order of</b></td></tr>
		<tr><td></td><td><b>2 . Website:<a href='https://www.gstat.nic.in' target='_blank'>gstat.nic.in</a></b></td><td><b>Hon'ble Acting Chairperson</b></td></tr>
	</table>
<?php
	}
}else{
