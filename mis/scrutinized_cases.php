    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">View Scrutinized Cases </h3>
...
$('input[type=radio][name=defect_status]').change(function() {
	...
	var item_per_page = $("#number_of_records").val();
	var search_filing_no = $("#search_filing_no").val();
	getdata(this.value,radioValue=1,item_per_page,from_date,end_date,search_filing_no);
});
...
function getdata(defect_status,radioValue,item_per_page,from_date,end_date,search_filing_no,url='get_cases_report.php?page=0'){
