    ...
    <div class="container-fluid">
        <table cellspacing="1" cellpadding="1" border="0" align="center">
            <div id="testdiv" style="visibility: visible;">
                ...
                <a style="float:right;" href="javascript::void('0');" onClick="return final_causelist('<?php echo $court_no; ?>','<?php echo $list_date; ?>');" class="button">
                    Finalize Causelist
                </a>
                </span>
                <a href="./causelist.php" class=" back-button">
                    <center>BACK</center>
                </a>
            </div>
        </table>
         ...
         $party_sr_no = htmlspecialchars($row12['pflag']).htmlspecialchars($row12['party_serial_no']);
             ...
             $party_sr_no = '';
                                        ...
                                        ?>
                                            <font face="Verdana" size="2">
                                            <?php
                                            if (strtolower($pet_advname22) != strtolower('none')) {
                                                echo strtoupper($pet_advname22) . "  " . $row12['remarks'] . '<br>';
                                            }
                                        }
                                            ?>
                                    </td>
                                    <td width="40%" align="left" valign="top">
                                        ...
                                        ?>
                                            <font face="Verdana" size="2">
                                            <?php
                                            if (strtolower($res_advname22) != strtolower('none')) {
                                                echo strtoupper($res_advname22) . "  " . $party_sr_no . " " . $row121['remarks'] . '<br>';
                                            }
                                        }
                                            ?>
                                            </font>
            ...
            <?php } else {
                echo $causelist_remark2;
            } ?>
            </textarea>-->
                    <br />
                    <table>
                        <tr>
                            <td style='padding-left:50px;'><button type='submit' name='submit'
                                    class='btn btn-primary btn-sm' id='save_causelist_remark_btn'>Save Remark</td>
                        </tr>
                    </table>
                </form>
        <?php
