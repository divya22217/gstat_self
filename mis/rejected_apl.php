    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">View Rejected Cases </h3>
...
function getdata(defect_status,radioValue,item_per_page,from_date,end_date,search_filing_no,url='get_rejected_cases.php?page=0'){
