...
Print</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:window.toExcel()"></b></a>
...
if(!empty($pjudgename)){
?>
<span><b><u>CORAM1:</u></b></span><span>1.</span><span><b><?php  print_r($pjudgename[0]['pjudgename']);  ?></b></span><br>
<?php
}
$jcount = 2;
...
?>
  <tr>
    ...
    <td><a  onclick="OpenDMSForm('https://efiling.nclt.gov.in/dms-ecourt/ecourt-search-within-dms','<?php echo $snoc; ?>','<?php echo $fileupload; ?>','<?php echo $courtnoc; ?>','<?php echo $main_case_no;?>','','<?php echo $petnamec ?>','<?php echo $petnamec."   "; ?>Vs.<?php echo "   ".$resnamec;?>','P','vVl/Az1yGsjOAG18WDeScg==','!TZFIMZbTiUtqXMfARJ1DGgyNicWFwYkwTA0ip/Q8Wns=')" style="cursor: pointer">
...
echo "<br>";?>
<br>
<a  onclick="OpenDMSForm('http://efiling.nclt.gov.in/dms-ecourt/ecourt-search-within-dms','<?php echo $snoc; ?>','<?php echo $fileupload; ?>','<?php echo $courtnoc; ?>','<?php echo $in_case_nor[$i]['case_no'];?>','','<?php echo $petnamec ?>','<?php echo $petnamec."   "; ?>Vs.<?php echo "   ".$resnamec;?>','P','vVl/Az1yGsjOAG18WDeScg==','!TZFIMZbTiUtqXMfARJ1DGgyNicWFwYkwTA0ip/Q8Wns=')" style="cursor: pointer">
...
echo "<br>";?>
<br>
<a  onclick="OpenDMSForm('http://efiling.nclt.gov.in/dms-ecourt/ecourt-search-within-dms','<?php echo $snoc; ?>','<?php echo $fileupload; ?>','<?php echo $courtnoc; ?>','<?php echo $in_case_nocp[$i]['case_no'];?>','','<?php echo $petnamec ?>','<?php echo $petnamec."   "; ?>Vs.<?php echo "   ".$resnamec;?>','P','vVl/Az1yGsjOAG18WDeScg==','!TZFIMZbTiUtqXMfARJ1DGgyNicWFwYkwTA0ip/Q8Wns=')" style="cursor: pointer">
...
<br>
<a  onclick="OpenDMSForm('http://efiling.nclt.gov.in/dms-ecourt/ecourt-search-within-dms','<?php echo $snoc; ?>','<?php echo $fileupload; ?>','<?php echo $courtnoc; ?>','<?php echo $ia_main_case_no;?>','','<?php echo $petnamec ?>','<?php echo $petnamec."   "; ?>Vs.<?php echo "   ".$resnamec;?>','P','vVl/Az1yGsjOAG18WDeScg==','!TZFIMZbTiUtqXMfARJ1DGgyNicWFwYkwTA0ip/Q8Wns=')" style="cursor: pointer">
...
echo "<br>";?>
<br>
<a  onclick="OpenDMSForm('http://efiling.nclt.gov.in/dms-ecourt/ecourt-search-within-dms','<?php echo $snoc; ?>','<?php echo $fileupload; ?>','<?php echo $courtnoc; ?>','<?php echo $ia_filingno_case_no[$i]['case_no'];?>','','<?php echo $petnamec ?>','<?php echo $petnamec."   "; ?>Vs.<?php echo "   ".$resnamec;?>','P','vVl/Az1yGsjOAG18WDeScg==','!TZFIMZbTiUtqXMfARJ1DGgyNicWFwYkwTA0ip/Q8Wns=')" style="cursor: pointer">
...
?>
<br>
<a  onclick="OpenDMSForm('http://efiling.nclt.gov.in/dms-ecourt/ecourt-search-within-dms','<?php echo $snoc; ?>','<?php echo $fileupload; ?>','<?php echo $courtnoc; ?>','<?php echo $connected_cases[$i]['case_no'];?>','','<?php echo $petnamec ?>','<?php echo $petnamec."   "; ?>Vs.<?php echo "   ".$resnamec;?>','P','vVl/Az1yGsjOAG18WDeScg==','!TZFIMZbTiUtqXMfARJ1DGgyNicWFwYkwTA0ip/Q8Wns=')" style="cursor: pointer">
...
$snoc ++;
 ...
 <?php //$snoc = $causelist->getSno($purpose,$snoc);
//echo $n = $causelist->roundNearestHundredUp(108);
?>
<?php
//$snoc ++; 
