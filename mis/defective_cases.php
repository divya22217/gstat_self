                                    ...
                                    <tr>
                                        <th>
                                            <input type="radio" name="c_case" value="1" onChange="submitForm3();"
                                                <?php if ($c_case == 1) {echo 'checked';}?>><b>Defective Cases</b>&nbsp;&nbsp;
                                        </th>
                                        <!--<th>
...
?>
                <table id="example1" class="table table-hovered table-stripped" >
                    <thead>
                        <tr>
                            <th>Sr No.</th>
...
$filing_nosend = $filing_no . '-' . $qq1cc;
                ...
                if ($upload_check != '0') {
                    ?>
                                        ...
                                        <?php 
echo '<a style="color: red;">Defective</a>'; ?>
		...
		<div align="center">
			...
			if($_REQUEST['page'] == $i) { 
				$clas_active = 'active';
						...
						if($i == 1):?>
						<li class='<?php echo $clas_active; ?>'  id="<?php echo $i;?>"><a href='defective_cases.php?page=<?php echo $i;?>&c_case=<?php echo $c_case; ?>'><?php echo $i;?></a></li> 
						<?php else:?>
						<li class='<?php echo $clas_active; ?>' id="<?php echo $i;?>"><a href='defective_cases.php?page=<?php echo $i;?>&c_case=<?php echo $c_case; ?>'><?php echo $i;?></a></li>
					<?php endif;?>			
			<?php endfor;endif;?>  
