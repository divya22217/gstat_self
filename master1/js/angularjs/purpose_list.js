...
myapp.controller('users', function ($scope, $http) {
    ...
    $scope.natureInformation = function () {
        $http({
            method: 'GET',
            url: 'purpose_ajax.php?action=purpose_list'
    ...
    $scope.addModal = function () {
        ...
        $("#purpose_form_id #action_text").val('insert');
        $('#form_modal').modal('show');
    };
    $scope.UserAddUpdate = function (users_form) {
        var users_information = users_form;
        var action_value = $("#purpose_form_id #action_text").val();
        $http({
            method: 'POST',
            url: 'purpose_ajax.php?action=' + action_value,
    ...
    $scope.EditModal = function (user) {
        ...
        $("#purpose_form_id #action_text").val('update');
        $('#form_modal').modal('show');
    };
    ...
    $scope.DeleteModal = function (user) {
        ...
        if (r == true) {
            $http({
                method: 'POST',
                url: 'purpose_ajax.php?action=delete',
                data: user.purpose_code,
            }).then(function (response) {
