...
$party_flag = "R";
        ...
        ?>
            ...
            if(($case_status == 'D' && $case_type_appeal == '1') || (!empty($case_disposal_data) && $case_disposal_data['disposal_nature'] == '46')) { 
                ...
                $query = "select personal_hearing,brief_order,order_status,det_amount_tax,det_amount_interest,det_amount_penalty,det_amount_fees,det_amount_others,det_amount_refund,demand_quantified,authority_name,direction_subject,order_ref_no,remand_order from $schemas.order_daily where filing_no  =?  and order_date = ? order by item_no desc limit 1";
