...
<title>Disconnected Cases</title>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
					<section class="content-header">
						<center><b>Disconnect Cases</b></center>
					</section>
					<?php
						...
						<div class="form-group row" id="search_form">
							...
							<div id="case_no_wise_search_form" style="display:none;">
								...
								<div class="col-sm-2 col-md-2 col-lg-2">
									<input type="number" class="form-control" placeholder="Enter Case Number" name="case_no" id="case_no">
								</div>
								<div class="col-sm-2 col-md-2 col-lg-2">
									<input type="number" class="form-control" placeholder="Enter Case Year" name="case_year" id="case_year">
								</div>
							</div>
							...
							<div class="col-sm-2 col-md-2 col-lg-2" id="search_button">
									<input type="button" name="submit" id="get_case" value="GO" onclick="return get_cases('','dis');" class="btn btn-primary btn-sm">
							</div>
						</div>
