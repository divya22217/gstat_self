            ...
            <div class="row red">
                ...
                <div class="col-md-12" style="font-size:16px;"><b>Is it a remand order:</b>
                                    ...
                                    <input type="radio" name="remand_order" id="rmd-n" value="0" onclick="remandOrder(0)"
                                        <?php echo ($remand_order == 0)?'checked':''; ?>>No</div>
                        ...
                        <?php if($case_type_appeal == 11)  { ?>
                            ...
                            <tr class="napatable">
                                ...
                                <td colspan="10">Type of order  -
                                    <select name="napa_order" class="form-control select">
                                        <option value='0' <?php echo ($napa_order == 0)?'selected':''; ?>>Select
                                            </option>
                                        <option value="1" <?php echo ($napa_order == 1)?'selected':''; ?>>Reduction in Price</option>
                                        <option value="2" <?php echo ($napa_order == 2)?'selected':''; ?>>Return to Recipient of Amount not passed on, along with interest</option>
                                        <option value="3" <?php echo ($napa_order == 3)?'selected':''; ?>>Deposit in Consumer Welfare Fund/s</option>
                                        <option value="4" <?php echo ($napa_order == 4)?'selected':''; ?>>Penalty Imposed(Amount to be specified): </option>
                                        <option value="5" <?php echo ($napa_order == 5)?'selected':''; ?>>Cancellation of Registration</option>
                                    </select>
                                </td>
                            </tr>
