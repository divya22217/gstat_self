...
if ($type == 'success') {
    ...
    if ($request_no != '') {
        ...
        $sqlq = "select case_year,case_no,case_type,location_code,status from $schemas.case_detail where filing_no=?";
    ...
    echo '<div class="text-center table-responsive">
                <table class="table table-bordered table-hover text-center">
                    ...
                    <div class="hide_print"><a href="./order_causelist.php" class="text-danger font-weight-bold"> << BACK << </a></div>
...
$party_flag = "R";
        ...
        ?>
                ...
                if($pet_advname22 != '') { 
                ?><input type="text" id="master_judges" name="r_master_judges[]"
                value="<?php echo $pet_advname22; ?>" placeholder="Enter Legal Representative Name"
                class="form-control name_list">
                                <?php } }}?>
            ...
            <?php if($case_status == 'D' && $case_type_appeal == '1') { 
                ...
                <div class="row red">
                            ...
                            <div class="col-md-6"><b>Order no. :</b> <span><?php echo $order_number; ?></span></div>
                            <div class="col-md-6 text-right"><b>Date of order :</b> <span><?php echo $list_date_link; ?></span></div>
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>2.</b></td>
                                            <td colspan="10">Name of the appellant - <span><?php echo $applicant_name; ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>3.</b></td>
                                            <td colspan="10">Address of the appellant - <span><?php echo $appellant_address;  ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>4.</b></td>
                                            <td colspan="4">Order appealed against - <span><?php echo $crn_number; ?></span>
                                            </td>
                                            <td colspan="3">Number - <span><?php echo $order_number; ?></span></td>
                                            <td colspan="3">Date - <span><?php echo $order_date; ?></span></td>
                                        </tr>
                                        <tr>
                                            <td><b>5.</b></td>
                                            <td colspan="4">Appeal no. - <span><?php echo $case_num; ?></span></td>
                                            <td colspan="6">Date - <span><?php echo $filing_date; ?></span></td>
                                        </tr>
                                        <tr>
                                            <td><b>6.</b></td>
                                            <td colspan="10">Personal Hearing -  <textarea 
                                                    name="personal_hearing" class="form-control" placeholder="Type here"><?php echo $personal_hearing; ?></textarea></td>
                                        </tr>
                                        <tr>
                                            <td><b>7.</b></td>
                                            <td colspan="10">Order in brief - <textarea name="brief_order"
                                                    class="form-control" placeholder="Type here"><?php echo $brief_order; ?></textarea></td>
                                        </tr>
                                        <tr>
                                            <td><b>8.</b></td>
                                            <td colspan="10">Status of order -
                                                <select name= "order_status" class="form-control select">
                                                    <option value='0' <?php echo ($order_status == 0)?'selected':''; ?>>Select Status</option>
                                                    <option value="1" <?php echo ($order_status == 1)?'selected':''; ?>>Confirmed</option>
                                                    <option value="2" <?php echo ($order_status == 2)?'selected':''; ?>>Modified</option>
                                                    <option value="3" <?php echo ($order_status == 3)?'selected':''; ?>>Rejected</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>9.</b></td>
                                            <td colspan="10">Amount of demand confirmed:</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" id="" name="central_determined_tax" class="tax form-control" value="<?php echo $taxa; ?>"></td>
                                            <td><?php echo $state_dis_tax; ?></td>
                                            <td><input type="number" id="" name="state_determined_tax" class="tax form-control" value="<?php echo $taxb; ?>"></td>
                                            <td><?php echo $intg_dis_tax; ?></td>
                                            <td><input type="number" id="" name="integrated_determined_tax" class="tax form-control" value="<?php echo $taxc; ?>"></td>
                                            <td><?php echo $cess_dis_tax; ?></td>
                                            <td><input type="number" id="" name="cees_determined_tax" class="tax form-control" value="<?php echo $taxd; ?>"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" id="" name="central_determined_interest" class="interest form-control" value="<?php echo $interesta; ?>"></td>
                                            <td><?php echo $state_dis_int; ?></td>
                                            <td><input type="number" id="" name="state_determined_interest" class="interest form-control" value="<?php echo $interestb; ?>"></td>
                                            <td><?php echo $intg_dis_int; ?></td>
                                            <td><input type="number" id="" name="integrated_determined_interest" class="interest form-control" value="<?php echo $interestc; ?>"></td>
                                            <td><?php echo $cess_dis_int; ?></td>
                                            <td><input type="number" id="" name="cees_determined_interest" class="interest form-control" value="<?php echo $interestd; ?>"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" id="" name="central_determined_penalty" class="penalty form-control" value="<?php echo $penaltya; ?>"></td>
                                            <td><?php echo $state_dis_pen; ?></td>
                                            <td><input type="number" id="" name="state_determined_penalty" class="penalty form-control" value="<?php echo $penaltyb; ?>"></td>
                                            <td><?php echo $intg_dis_pen; ?></td>
                                            <td><input type="number" id="" name="integrated_determined_penalty" class="penalty form-control" value="<?php echo $penaltyc; ?>"></td>
                                            <td><?php echo $cess_dis_pen; ?></td>
                                            <td><input type="number" id="" name="cees_determined_penalty" class="penalty form-control" value="<?php echo $penaltyd; ?>"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" id="" name="central_determined_fees" class="fees form-control" value="<?php echo $feesa; ?>"></td>
                                            <td><?php echo $state_dis_fee; ?></td>
                                            <td><input type="number" id="" name="state_determined_fees" class="fees form-control"  value="<?php echo $feesb; ?>"></td>
                                            <td><?php echo $intg_dis_fee; ?></td>
                                            <td><input type="number" id="" name="integrated_determined_fees" class="fees form-control"  value="<?php echo $feesc; ?>"></td>
                                            <td><?php echo $cess_dis_fee; ?></td>
                                            <td><input type="number" id="" name="cees_determined_fees" class="fees form-control"  value="<?php echo $feesd; ?>"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" id="" name="central_determined_others" class="others form-control"  value="<?php echo $othersa; ?>"></td>
                                            <td><?php echo $state_dis_oth; ?></td>
                                            <td><input type="number" id="" name="state_determined_others" class="others form-control" value="<?php echo $othersb; ?>"></td>
                                            <td><?php echo $intg_dis_oth; ?></td>
                                            <td><input type="number" id="" name="integrated_determined_others" class="others form-control" value="<?php echo $othersc; ?>"></td>
                                            <td><?php echo $cess_dis_oth; ?></td>
                                            <td><input type="number" id="" name="cees_determined_others" class="others form-control" value="<?php echo $othersd; ?>"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" id="" name="central_determined_refund" class="refund form-control" value="<?php echo $refunda; ?>"></td>
                                            <td><?php echo $state_dis_rfn; ?></td>
                                            <td><input type="number" id="" name="state_determined_refund" class="refund form-control" value="<?php echo $refundb; ?>"></td>
                                            <td><?php echo $intg_dis_rfn; ?></td>
                                            <td><input type="number" id="" name="integrated_determined_refund" class="refund form-control" value="<?php echo $refundc; ?>"></td>
                                            <td><?php echo $cess_dis_rfn; ?></td>
                                            <td><input type="number" id="" name="cees_determined_refund" class="refund form-control" value="<?php echo $refundd; ?>"></td>
                            ...
                            <div class="col-md-12 text-right">
                                ...
                                <p><span><?php echo strtoupper($_SESSION['schema_name']).'  '.$_SESSION['user_actual_name']; ?></span></p>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-content collapse in">
                                        <textarea name="order_of_tribunal" id="order_tribunal" cols="60" rows="20"><?php echo $order_tribunal; ?></textarea>
                                    </div>
                                </div>
