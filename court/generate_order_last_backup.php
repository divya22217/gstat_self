...
$party_flag = "R";
        ...
        ?>
            ...
            <?php if($case_status == 'D' && $case_type_appeal == '1') { 
                ...
                $query = "select personal_hearing,brief_order,order_status,det_amount_tax,det_amount_interest,det_amount_penalty,det_amount_fees,det_amount_others,det_amount_refund,demand_quantified,authority_name,direction_subject,order_ref_no from $schemas.order_daily where filing_no  =?  and order_date = ? order by item_no desc limit 1";
                ...
                where a.filing_no = '2024107201000004'";
            ...
            <div class="row red">
                ...
                <div class="col-md-6 text-right"><b>Date of order :</b> <span><?php echo $list_date_link; ?></span>
                </div>
                <div class="col-md-12">
                    <table class="table table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td><b>3.</b></td>
                                <td colspan="10">Name of the appellant -
                                    <span><?php echo $applicant_name. ' , ' .$applicant_email. ' , ' .$applicant_mobile; ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td><b>4.</b></td>
                                <td colspan="10">Name of the respondant -
                            ...
                            <tr>
                                ...
                                <td colspan="10">If demand order then whether demand quantified:
                                    <input type="radio" name="demand_quantified" id="q1-y" value="1" onclick="toggleContent(1)"
                                        <?php echo ($demand_quantified == 1)?'checked':''; ?>>Yes
                                    <input type="radio" name="demand_quantified" id="q1-n" value="0" onclick="toggleContent(0)"
                                        <?php echo ($demand_quantified == 0)?'checked':''; ?>>No
                                </td>
                            </tr>
                    </table>
                    <table id="hideTable" class="table table-striped table-bordered">
                        <tr>
                            <td colspan="11">
                        ...
                        <tr>
                            ...
                            <td><input type="number" id="" name="cees_determined_interest" class="interest form-control"
                                    value="<?php echo $interestd; ?>"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" id="" name="state_determined_penalty" class="penalty form-control"
                                    value="<?php echo $penaltyb; ?>"></td>
                            ...
                            <td><input type="number" id="" name="cees_determined_penalty" class="penalty form-control"
                                    value="<?php echo $penaltyd; ?>"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" id="" name="integrated_determined_fees" class="fees form-control"
                                    value="<?php echo $feesc; ?>"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" id="" name="central_determined_others" class="others form-control"
                                    value="<?php echo $othersa; ?>"></td>
                            <td><?php echo $state_dis_oth; ?></td>
                            <td><input type="number" id="" name="state_determined_others" class="others form-control"
                                    value="<?php echo $othersb; ?>"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" id="" name="central_determined_refund" class="refund form-control"
                                    value="<?php echo $refunda; ?>"></td>
                            <td><?php echo $state_dis_rfn; ?></td>
                            <td><input type="number" id="" name="state_determined_refund" class="refund form-control"
                                    value="<?php echo $refundb; ?>"></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $value['dispttaxamt']; ?></td>
                            <td><?php echo $value['disptinterestamt']; ?></td>
                            <td><?php echo $value['disptpenalityamt']; ?></td>
                            <td colspan="2"><?php echo $value['disptothersamt']; ?></td>
                            <td colspan="2">
                                <?php echo $value['dispttaxamt']+$value['disptinterestamt']+$value['disptpenalityamt']+$value['disptothersamt']; ?>
                            </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td colspan="15" align="center" class="text-center">
                    <input id="submit1" class="btn btn-primary submit-btn" type="button" name="submit1" value="Submit" onClick="return submitFormsub();" />
                </td>
            </tr>
