...
//    }
	...
	$stnq = $db->prepare("select * from $schemas.order_daily where order_date=?");
...
echo "<h7><font>";
                ...
                ?>
                                ...
                                <td>
                                    <?php echo htmlspecialchars($next_list_date); ?>
                                </td>
                                <!-- <td>
                                <?php if ($flag == 'N') {?>
                                ...
                                <td><center> <?php if ($role_id == '5' && $send_by_member == '1') {?> <input type="button"
                                    ...
                                    <?php } else if($role_id == '5' && $flag == 'Y' && $send_by_member == '2') {?>
                                    <a href="../order_view.php?path=<?php echo base64_encode($pdf_path) ?>"
                                        target="_blank" title="View"><button type="button"
                                            class="btn btn-none"><i class="fa fa-eye"></i></button></a>
                                    <?php } else if ($role_id == '3' && $flag == 'N' && $send_by_member == '0') { ?>
                                            <input type="button"
