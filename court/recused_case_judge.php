...
function search_data(){
	...
	data: {type:'search_case_to_recuse_judge',case_type:case_type,case_no:case_no,case_year:case_year},
...
function recuse_judge(filing_no){
	var judge_code = $("#master_judge_"+filing_no).val();
	if(judge_code == ''){
		swal('','please select judge','warning');
		return false;
	}
	swal({
            title: "Are you sure ??",
		...
		.then((willDelete) => { 
             if (willDelete) {
				$.ajax({
					type: "POST",
					url: "upload_order_ajax.php",
					data: {type:'recuse_submit',filing_no:filing_no,judge_code:judge_code},
					dataType: 'json',
...
function remove_recuse_judge(filing_no,id){
		swal({
            title: "Are you sure ??",
            text: "", 
            icon: "warning",
		...
		.then((willDelete) => { 
             if (willDelete) {
				$.ajax({
					type: "POST",
					url: "upload_order_ajax.php",
					data: {type:'remove_recuse_judge',filing_no:filing_no,recuse_id:id},
					dataType: 'json',
