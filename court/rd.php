...
<tr>
		...
		<span class="error"> <b> <?php  echo "RECORD ALREADY EXISTS IN RD"; ?></span></font>
		</td>
		</tr>
		<tr>
		<td height="30" align="center" cellpadding="0" colspan="6">
...
<?php
$st = $dbonline->prepare("select * from e_master_rd where display = 'TRUE' order by rd_id asc");
$st->execute();
while ($row = $st->fetch(PDO::FETCH_ASSOC,PDO::FETCH_ORI_NEXT))
{
