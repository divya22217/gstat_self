		...
		if(change_name_rp.value=='')
{
	alert("Please Select Date of RP Change");
		...
		if(accp_rej.value=='')
{
	alert("Please Select Date of Acceptance/Rejection");
			accp_rej.select();
			return false;
}*/
   	
		action = "irp_modify_action.php";
		submit();
	}
}
...
?>
<?php 
$sql2=$db->prepare("select * from  $schemas.irp_detail where filing_no=? and role='2' ");
...
$st = $db->prepare("select * from $schemas.master_role_irp where display = 'TRUE'  and code IN(2) order by role_name asc");
$st->execute();
while ($row = $st->fetch(PDO::FETCH_ASSOC,PDO::FETCH_ORI_NEXT))
{
...
<td>
<input type="text" id="case_no1" maxlength="15" autocomplete="off" size="15" name="case_no1" readonly value="<?php echo $case_no1; ?>"/>
</td> 
 </tr>
...
<tr>
<td  align="left"><font face="Verdana" size="2" color="red"></font><font face="Verdana" size="2">Date Confirmation of RP</font></td>
<td align="left" ><input type="text"  maxlength="10" size="10" name="confirmation_rp" id="confirmation_rp" class="datepickerToday" value="<?php print htmlspecialchars($confirmation_rp); ?>" </td>
</tr>
<tr>
<td  align="left"><font face="Verdana" size="2" color="red"></font><font face="Verdana" size="2">Date of IRP Name Change</font></td>
<td align="left" ><input type="text"  maxlength="10" size="10" name="change_name_irp" id="change_name_irp" class="datepickerToday" value="<?php print htmlspecialchars($change_name_irp); ?>" </td>
</tr>

<tr>
<td  align="left"><font face="Verdana" size="2" color="red"></font><font face="Verdana" size="2">Date of RP Name Change</font></td>
<td align="left" ><input type="text"  maxlength="10" size="10" name="change_name_rp" id="change_name_rp" class="datepickerToday" value="<?php print htmlspecialchars($change_name_rp); ?>" </td>
</tr>


<tr>
<td  align="left"><font face="Verdana" size="2" color="red"></font><font face="Verdana" size="2">Date of Accepatance/Rejection(Direction of Court)</font></td>
<td align="left" ><input type="text"  maxlength="10" size="10" name="accp_rej" id="accp_rej" class="datepickerToday" value="<?php print htmlspecialchars($accp_rej); ?>" </td>
</tr>

<!--
 <tr>
<td><font face="Verdana" size="2" color="red">*</span> </font><font face="Verdana" size="2">Upload file</font>
</td>
<td>
...
<td>
<input type="text" id="enrol_no" maxlength="50" autocomplete="off" size="50" name="enrol_no" value="<?php echo $enrolment_no; ?>"/>
</td> 
 </tr>
</table>
 <table cellspacing="0" align="center" cellpadding="2" border="1" width="90%" class="std">
...
?>
 ...
 //if($filing_no!='' and $filing_no333=='' and $filing_no1!='')
	// if($filing_no!='' and $filing_no3=='' )

if($filing_no!='' and $filing_no333!='' and $filing_no3=='')
 {
	 ?>
 <tr>
