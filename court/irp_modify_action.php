...
$subject="Assignment as RP under Case Number:".$CASE_NO." by Honorable NCLT ".$lcodename ;
	   
$email_text="You have been assigned as RP under Case Number ".$CASE_NO." This is a Computer Generated message, Please do not reply";
$msg555="You have been assigned as RP Under Case Number ".$CASE_NO." by honorable ".$lcodename;



  $sql ="insert into sms(filing_no,case_number,msg,subject,email_text,send_flag,entry_date,sms_flag,email_irp_rp,mobile_irp_rp,irp_rp_name) 
VALUES('$filing_no','$CASE_NO','$msg555','$subject','$email_text','0','$server_date','R','$email','$mobile','$name')";
...
header("Location:./irp_modify.php?msg=$msg");
