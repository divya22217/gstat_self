...
?>
<tr>
<td align="center" colspan="7" style="font-size:16px;"><b><u><?php echo get_bench_address($db,$schemas,$main_location_code); ?>
</u></b>
</td>
</tr>
<tr>
...
$is_proceeded = proceeding_status($schemas,$db,$filing_no,$listdate_entire);
if($is_proceeded){
	$color = 'color:#ffffff;';
...
$serial_no=$sr_no-1;
$filing_no_link1=$filing_no."@".$court_no."@".$list_date."@".$list_before."@".$list_flag."@".$purpose_code."@".$bench_code1;
?>
